      ...
      <div className={`${styles.servicesPage} themeBgColor`}>
        <div className="container">
          <div className="d-flex flex-column justify-content-center align-items-center">
            <StaticImage
              src="../../images/exhibition-icon.png"
              width={150}
              height={150}
            />
        ...
        <div className="themeBgColorSecond py-5">
          <div data-aos="fade-up" className="container text-center">
            ...
            <h3 className="my-4">Why Choose Exhibition Carpets</h3>
...
export const query = graphql`
  query {
    gallery: allFile(
      filter: { relativeDirectory: { eq: "gallery/Exhibition Carpets" } }
    ) {
      edges {
        node {
          id
