      ...
      <div className={`${styles.servicesPage} themeBgColor`}>
        <div className="container">
          <div className="d-flex flex-column justify-content-center align-items-center">
            <StaticImage
              ...
              height={150}
            />
            <h1>Office Carpets</h1>
          </div>
        </div>
        <SideImage
          image={
            <StaticImage
              src="../../images/office-carpets (2).jpg"
              width={500}
              height={500}
            />
          }
        ...
        <div className="themeBgColorSecond py-5">
          <div data-aos="fade-up" className="container text-center">
            ...
            <h3 className="my-4">Why Choose Office Carpets</h3>
...
export const query = graphql`
  query {
    gallery: allFile(
      filter: { relativeDirectory: { eq: "gallery/Office Carpets" } }
    ) {
      edges {
        node {
          id
