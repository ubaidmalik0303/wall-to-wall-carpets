    ...
    <Layout>
      <div className={`${styles.servicesPage} themeBgColor`}>
        ...
        <SideImage
          image={
            <StaticImage
              src="../../images/mosque-carpets.webp"
              width={500}
              height={500}
            />
          }
        ...
        <div className="themeBgColorSecond py-5">
          <div data-aos="fade-up" className="container text-center">
            ...
            <h3 className="my-4">Why Choose Mosque Carpets</h3>
...
export const query = graphql`
  query {
    gallery: allFile(
      filter: { relativeDirectory: { eq: "gallery/Mosque Carpets" } }
    ) {
      edges {
        node {
          id
