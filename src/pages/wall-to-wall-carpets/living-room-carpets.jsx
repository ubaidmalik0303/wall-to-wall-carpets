      ...
      <div className={`${styles.servicesPage} themeBgColor`}>
        <div className="container">
          <div className="d-flex flex-column justify-content-center align-items-center">
            <StaticImage
              src="../../images/livingroom-icon.png"
              width={150}
              height={150}
            />
            <h1>Livingroom Carpets</h1>
          </div>
        </div>
        <SideImage
          image={
            <StaticImage
              src="../../images/livingroom-carpets.jpg"
              width={500}
              height={500}
            />
          }
        ...
        <SideImage
          ...
          image={
            <StaticImage
              src="../../images/livingroom-carpets.png"
              width={500}
              height={500}
            />
          }
        ...
        <div className="themeBgColorSecond py-5">
          <div data-aos="fade-up" className="container text-center">
            ...
            <h3 className="my-4">Why Choose Livingroom Carpets</h3>
...
export const query = graphql`
  query {
    gallery: allFile(
      filter: { relativeDirectory: { eq: "gallery/Livingroom Carpets" } }
    ) {
      edges {
        node {
          id
...
export default LivingroomCarpets;
