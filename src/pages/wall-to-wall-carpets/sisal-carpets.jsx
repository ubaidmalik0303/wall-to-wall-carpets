    ...
    <Layout>
      <div className={`${styles.servicesPage} themeBgColor`}>
        ...
        <SideImage
          image={
            <StaticImage
              src="../../images/sisal-carpets (2).jpg"
              width={500}
              height={500}
            />
          }
        ...
        <div className="themeBgColorSecond py-5">
          <div data-aos="fade-up" className="container text-center">
            ...
            <h3 className="my-4">Why Choose Sisal Carpets</h3>
...
export const query = graphql`
  query {
    gallery: allFile(
      filter: { relativeDirectory: { eq: "gallery/Sisal Carpets" } }
    ) {
      edges {
        node {
          id
